...
public class MethodRef4 {
    ...
    public static void main(String[] args) {
        ...
        List<String> upperResult1 = mapStringString(result1, (String s) -> s.toUpperCase());
        List<String> upperResult2 = mapStringString(result1, String::toUpperCase);
    ...
    static List<String> mapStringString(List<String> Strings, Function<String, String> fun){
        List<String> result = new ArrayList<>();
