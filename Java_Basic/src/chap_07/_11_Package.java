...
public class _11_Package {
    public static void main(String[] args) {
        ...
        System.out.println("랜덤 정수 (범위) : "+ random.nextInt(10)); // 0 이상 10 미만 (0~9)
        System.out.println("랜덤 실수 : "+ random.nextDouble()); // 0.0 <= x <1.0
//        System.out.println("랜덤 실수 (범위) : "+ random.nextDouble(10.0));
        ...
        System.out.println("로또 번호 : " + random.nextInt(45) + 1); // 1 이상 45 이하
